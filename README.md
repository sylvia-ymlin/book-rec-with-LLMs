...
| User Base | 167,968 | Active users (≥3 ratings) |
| Book Catalog | 152,052 | Books with ratings |

### Latency Benchmarks
| Operation | P50 Latency |
|:---|:---|
| Vector Search | ~200ms |
| Full RAG Pipeline | ~400ms |
| Personalized Rec | ~100ms |
