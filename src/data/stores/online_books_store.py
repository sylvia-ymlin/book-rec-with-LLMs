...
Moved from `src/core/online_books_store.py` into `src.data.stores`.
"""
...
class OnlineBooksStore:
    ...
    def __init__(self):
        ...
        self._ensure_schema()
        logger.info(
            "OnlineBooksStore: Initialized (staging store for web-discovered books)"
        )
    ...
    def _ensure_schema(self) -> None:
        ...
        try:
            ...
            cursor.execute(
                "CREATE INDEX IF NOT EXISTS idx_online_isbn10 ON online_books (isbn10)"
            )
            cursor.execute(
    ...
    def insert_book_with_fts(self, row: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            isbn10 = row.get(
                "isbn10",
                isbn13[:10] if len(isbn13) >= 10 else isbn13,
            )
            ...
            conn.commit()
            logger.info("OnlineBooksStore: Inserted %s (staging)", isbn13)
            return True
        except Exception as e:
    ...
    def get_all_categories(self) -> List[str]:
        ...
        try:
            ...
            logger.debug("OnlineBooksStore get_all_categories failed: %s", e)
            return []
    ...
    def fts_search(self, query: str, k: int = 10) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            logger.debug("OnlineBooksStore FTS search failed: %s", e)
            return []


online_books_store = OnlineBooksStore()

__all__ = ["OnlineBooksStore", "online_books_store"]
